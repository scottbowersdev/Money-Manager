          ...
          <tbody>
            <tr>
              <td><table class="row">
                  <tbody>
                    <tr>
                      <th class="small-12 large-12 columns first last"> <table>
                          <tr>
                            <th>
                            
                              <!-- Header image -->
                              <img src="<?= $url_website ?>img/logo.png" alt="" style="display:block; margin:0 auto 20px auto;" />
                              <!-- Header image -->
                              
                              <!-- Main content -->
                              <h4>Contact Form</h4>
                              <p>Please find contact form information below</p>
                              <!-- Main content -->
                              ...
                              <table>
                                ...
                                <tr>
                                  <th valign="top"><strong>Message</strong></th>
                                  <th><?= stripslashes(preg_replace('/\v+|\\\[rn]/','<br/>',$message)); ?></th>
                                </tr>
                              </table>
                              <!-- Table -->
                                ...
                                <tr>
                                  <td>
                                    <table>
                                      <tr>
                                        <td>
                                          <center data-parsed=""><a href="#" align="center" class="text-center">Reset Password</a></center>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                              ...
                              <!-- Footer Text -->
                              <hr>
                              <center data-parsed=""><small>Name | Address | Number</small></center>
                              <!-- Footer Text -->
