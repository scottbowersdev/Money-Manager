...
<link rel="mask-icon" href="<?= $url_website ?>img/resources/favicon/safari-pinned-tab.svg" color="#333333">
...
<!-- User Defined Data -->
<!-- Stylesheet -->
<link href="<?= $url_website ?>style/main.css?v=5" rel="stylesheet" type="text/css">
<!-- Stylesheet -->
<!-- jQuery -->
