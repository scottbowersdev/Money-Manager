...
<div id="right-nav">
  <div>
    ...
    <ul>
      <!--<li><a href="<?= $url_website ?>admin/archives/"><span class="fa fa-fw fa-archive"></span> Archives</a></li>-->
      ...
      <!--<li><a href="<?= $url_website ?>admin/settings/"><span class="fa fa-fw fa-cog"></span> Account Settings</a></li>-->
